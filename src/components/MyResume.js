      ...
      {resumes.length === 0 ? (
        ...
        <div className="resume-list">
          <div className="resume-header">
            ...
            <div className="resume-template">Template ID</div>
            <div className="resume-modified">Modified</div>
            <div className="resume-actions">Actions</div>
          </div>
          {resumes.map((resume) => (
            <div key={resume.id} className="resume-item">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: breakLongWordsHtml(resume.name, 15),
                }}
              />
              <div className="resume-template">{resume.templateId}</div>
